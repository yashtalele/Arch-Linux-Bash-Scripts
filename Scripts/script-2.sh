...
yes | sudo pacman -S kvantum

echo "Installing Latte Dock"
yes | sudo pacman -S latte-dock

echo "KDE Plasma Addons"
yes | sudo pacman -S kdeplasma-addons
...
echo "Installing Catapult"
yay -S catapult

echo "Installing GTK Module"
...
echo "Unblocking KDE Connect from firewall"
...
sudo echo "cp -f /etc/resolv.conf.override /etc/resolv.conf" > /etc/NetworkManager/dispatcher.d/override.sh
...
# Check : => cat /proc/driver/nvidia/gpus/0000\:01\:00.0/power
#
# Add this to ksuperkey.desktop in /usr/share/applications/
# [Desktop Entry]
# Exec=ksuperkey
...
echo "https://github.com/jdhao/nvim-config"


echo "https://www.youtube.com/watch?v=jncc3QL8RWI"
echo "https://wiki.archlinux.org/title/NVIDIA#Configuration"
echo "https://wiki.archlinux.org/title/NVIDIA_Optimus#Using_optimus-manager"
echo "Optimus Manager : https://github.com/Askannz/optimus-manager"
